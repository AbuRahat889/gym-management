...
const PopulerClass = () => {
  const classes = [
    {
      ...
      time: "6 PM - 8 PM",
      description:
        "BodyCombat is the empowering cardio workout where you are totally unleashed. This fiercely energetic program is inspired by martial arts.",
    },
    {
      title: "Yoga Fitness",
  ...
  return (
    <div className="container flex flex-col lg:flex-row gap-2 items-center justify-center p-6">
      {/* Sidebar Content */}
      <div className="bg-black text-white p-6 h-[358px] w-52 rounded-lg shadow-lg pb-10">
        ...
        >
          ...
          {classes.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="border rounded-lg shadow-lg overflow-hidden h-[358px]">
                {/* Class Image */}
